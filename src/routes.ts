...
import { TrainGroupController } from "./modules/groups/useCases/trainGroup/TrainGroupController";
...
const trainGroupController = new TrainGroupController();
...
routes.post("/group/train", trainGroupController.handle);
